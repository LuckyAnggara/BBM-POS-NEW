 ...
 */
export const listInvoices = async (params: ListInvoicesParams = {}): Promise<PaginatedInvoices> => {
  try {
...
export const updateInvoiceStatus = async (
  ...
  try {
    ...
    console.error(`Laravel API Error :: updateInvoiceStatus (ID: ${id}) :: `, error)
    throw error
  }
}
...
export const downloadInvoicePDF = async (id: number): Promise<Blob> => {
  try {
    ...
    console.error(`Laravel API Error :: downloadInvoicePDF (ID: ${id}) :: `, error)
    throw error
  }
}
...
export const markInvoiceOverdue = async (id: number): Promise<Invoice> => {
  try {
    ...
    console.error(`Laravel API Error :: markInvoiceOverdue (ID: ${id}) :: `, error)
    throw error
  }
}
...
export const getInvoiceSummary = async (branchId: string | number): Promise<InvoiceSummary> => {
  try {
 ...
 */
export const generateInvoiceNumber = async (branchId: string | number): Promise<string> => {
  try {
